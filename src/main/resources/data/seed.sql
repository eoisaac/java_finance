...
INSERT INTO transactions (id, name, type, price, entry_date, category_id, created_at, updated_at) VALUES (gen_random_uuid(), 'Compras aliexpress', 'EXPENSE', 50.0, NOW(), (SELECT id FROM categories WHERE name = 'COMPRAS'), NOW(), NOW());
...
INSERT INTO transactions (id, name, type, price, entry_date, category_id, created_at, updated_at) VALUES (gen_random_uuid(), 'Vendas mercado', 'INCOME', 2500.0, NOW(), (SELECT id FROM categories WHERE name = 'OUTROS'), NOW(), NOW());
