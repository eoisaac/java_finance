...
public class TransactionUtilsTest {
    ...
    public void createTransactionsSummary() {
        ...
        assertEquals("Transaction summary total income should be the same as the expected total income",
                expectedTotalIncome, summary.getTotalIncome(), 0.0f);
        assertEquals("Transaction summary total expense should be the same as the expected total expense",
                expectedTotalExpense, summary.getTotalExpense(), 0.0f);
        assertEquals("Transaction summary total balance should be the same as the expected total balance",
                expectedTotalBalance, summary.getTotalBalance(), 0.0f);
    }
}
